...
DISCOVERY_MAX_AGE_DAYS: int = int(os.environ.get("DISCOVERY_MAX_AGE_DAYS", "365"))
...
def rank_candidates(
    ...
    *,
    ...
    for candidate in candidates:
        ...
        # --- Min views gate ---
        # If view_count is 0, treat as unknown (yt-dlp search may not return it)
        # Only filter if we actually have view data
        if view_count > 0 and view_count < _min_views:
            continue
